        ...
        <div class="row">
            ...
            <small><small>
                    <div class="card-body pt-0">
                        <div class="row">
                            <div class="col">
                                Nro. Recibo: <b><?php echo $recibo['id'] ?></b>
                            </div>
                            <div class="col">
                                Nro. Orden: <b><?php echo $recibo['id_orden'] ?></b>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
